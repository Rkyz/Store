...
const SwiperCard = () => {
    return (
        ...
        >
            <SwiperSlide>
                <div className="dark:bg-Darkmode bg-lightmode border-gray-600 text-white rounded-xl shadow-lg flex h-full max-lg:flex-col z-30">
                    ...
                    <div className='w-[15%] max-2xl:w-[20%] max-lg:w-[100%] max-lg:flex-row p-4 flex flex-col justify-between'>
                        ...
                        <h3 className='dark:text-yellow-500 text-blue-500'>1 August 2006</h3>
                        <h3 className="text-xl font-semibold mb-2 text-gray-400 dark:text-white">Lorem</h3>
                        </div>
                        <div className='flex gap-5 flex-col'>
                            <button className='text-left text-blue-500 dark:text-yellow-500 max-lg:hidden'>Baca Selengkapnya</button>
