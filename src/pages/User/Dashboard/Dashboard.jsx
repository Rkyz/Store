...
import SearchCard from "../../../components/User/Card/SearchCard";
            ...
            <div className="max-lg:h-[50rem] scrollbar-hidden relative">
                <div className={`lg:ml-[130px] max-lg:mx-[30px] max-md:mx-[15px] lg:mr-[30px] h-[40vh]  ${searchActive ? 'max-lg:mx-[10px]' : ''
                    ...
                    <div className="flex justify-between">
                        <ul>
                            <p className="text-blue-500 dark:text-yellow-500 mt-5 text-[12px] uppercase font-semibold ">
                                Game Populer
                            </p>
                            <h1 className="text-black text-opacity-80 dark:text-white text-[32px] font-bold">Tren Sekarang</h1>
                            <div className="py-4">
                            <ul className="flex gap-3">
                                <li>
                                <a
                                    href=""
                                    className={`text-black text-opacity-80 dark:text-white bg-lightmode dark:bg-Darkmode px-5 py-2 rounded-md hover:bg-yellow-500 hover:text-white dark:hover:text-white dark:hover:bg-blue-500 ${activeTab === 'all' ? 'bg-blue-500' : ''}`}
                                    onClick={(e) => {
                                    e.preventDefault();
                                    handleTabClick('all');
                                ...
                                <a
                                    href=""
                                    className={`text-black text-opacity-80 dark:text-white bg-lightmode dark:bg-Darkmode px-5 py-2 rounded-md hover:bg-yellow-500 hover:text-white dark:hover:text-white dark:hover:bg-blue-500 ${activeTab === 'popular' ? 'bg-blue-500' : ''}`}
                                    onClick={(e) => {
                                    e.preventDefault();
                                ...
                                <a
                                    href=""
                                    className={`text-black text-opacity-80 dark:text-white bg-lightmode dark:bg-Darkmode px-5 py-2 rounded-md hover:bg-yellow-500 hover:text-white dark:hover:text-white dark:hover:bg-blue-500 ${activeTab === 'topup' ? 'bg-blue-500' : ''}`}
                                    onClick={(e) => {
                                    e.preventDefault();
                                ...
                                <a
                                    href=""
                                    className={`text-black text-opacity-80 dark:text-white bg-lightmode dark:bg-Darkmode px-5 py-2 rounded-md hover:bg-yellow-500 hover:text-white dark:hover:text-white dark:hover:bg-blue-500 ${activeTab === 'joki' ? 'bg-blue-500' : ''}`}
                                    onClick={(e) => {
                                    e.preventDefault();
                                    handleTabClick('joki');
                    ...
                    <div className="w-full flex justify-center mt-8">
                        <button className=" text-white  w-[88%] max-lg:w-full dark:bg-blue-500 bg-yellow-500 h-10 rounded-md">Lebih Banyak</button>
                    </div>
                    <div className="w-full flex h-[999px] flex-col mt-10">
                        <p className="text-blue-500 dark:text-yellow-500 mt-5 text-[12px] uppercase font-semibold ">
                            Saluran Game
                        </p>
                        <h1 className="dark:text-white text-[32px] font-bold mb-7 text-opacity-80">Info Terkini</h1>
                            ...
                            <div className="w-[70%] bg-transparent flex justify-center items-center max-lg:w-full h-[100%] max-lg:h-[65%] rounded-lg lg:mr-5 max-lg:mb-5">
                                ...
                                {!selectedVideo && videos.length === 0 && (
                                    <div>
                                        ...
                                        <div className='flex justify-center'>
                                            <p className='animate-bganimate dark:text-white '>No Videos Available</p>
                                        </div>
                                    </div>
                                )}
                            </div>
